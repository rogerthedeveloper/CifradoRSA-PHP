...
CREATE TABLE `caja` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=116 DEFAULT CHARSET=ucs2 COLLATE=ucs2_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `caja` VALUES (96,'2018-12-12',0,5000,-5000.00,''),(97,'2018-12-12',0,5000,-10000.00,''),(98,'2018-12-12',0,500,-10500.00,''),(99,'2018-12-12',9400,0,-1100.00,''),(100,'2018-12-12',15,0,-1085.00,''),(101,'2019-02-04',3000,0,1915.00,''),(102,'2019-02-04',3000,0,4915.00,''),(103,'2019-02-13',100,0,5015.00,''),(104,'2019-02-13',3050,0,8065.00,''),(105,'2019-02-15',3000,0,11065.00,''),(106,'2019-02-15',3000,0,14065.00,''),(107,'2019-02-15',3000,0,17065.00,''),(108,'2019-02-15',3100,0,20165.00,''),(109,'2019-02-15',3100,0,23265.00,''),(110,'2019-02-15',3100,0,26365.00,''),(111,'2019-02-15',3100,0,29465.00,''),(112,'2019-02-19',100,0,29565.00,''),(113,'2019-02-20',200,0,29765.00,''),(114,'2019-03-07',30,0,29795.00,''),(115,'2019-03-07',10,0,29805.00,'');
...
INSERT INTO `categoria` VALUES (1,'Linea blanca'),(2,'Linea de sala'),(3,'Utiles de Oficina');
...
INSERT INTO `cliente` VALUES (1,'Byron Fernando Calderon Ferrera ',2743342160201,'8847961-7','Aldea Santa Lucia','El Progreso','Guastatoya','Donde hay una funeraria','30349707','bcalderonf18@gmail.com',1,4900.00),(2,'Roger Sosa',2314035500101,'8357481-6','Barrio las Joyas','El Progreso','Guastatoya','En el callejon despues del mine. de trabajo, hasta adentro.','53436438','rogerthedeveloper@gmail.com',1,80.00),(3,'oscar antnio valiente',1705762480201,'1017228-9','1a ave. 2-23 zona 6,','El Progreso','Guastatoya','a la par de una casa','59600502','tonyvaliente@gmail.com',1,50.00);
...
INSERT INTO `compra` VALUES (1,1,1632631,'2019-03-07',2,1,0,'',20);
...
INSERT INTO `detalle_compra` VALUES (1,1,'4902505089176',1,20.00);
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=ucs2 COLLATE=ucs2_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `detalle_venta` VALUES (14,13,'4902505089176',1,NULL,30.00),(15,14,'4902505089176',2,NULL,60.00),(16,15,'4902505089176',5,NULL,150.00),(17,16,'4902505089176',3,NULL,90.00),(18,17,'4902505089176',1,NULL,30.00),(19,18,'4902505089176',49,NULL,1470.00),(20,19,'4902505089176',1,NULL,30.00),(21,20,'4902505089176',1,NULL,30.00),(22,21,'4902505089176',1,NULL,30.00),(23,22,'4902505089176',1,NULL,30.00),(24,23,'4902505089176',3,NULL,90.00);
...
INSERT INTO `inventario` VALUES (27,'4902505089176','2019-03-07',100,0,'Compra',100),(28,'4902505089176','2019-03-07',0,1,'Venta',99),(29,'4902505089176','2019-03-07',1,0,'Venta',100),(30,'4902505089176','2019-03-08',0,2,'Venta',98),(31,'4902505089176','2019-03-06',0,5,'Venta',93),(32,'4902505089176','2019-02-15',0,3,'Venta',90),(33,'4902505089176','2018-12-13',0,1,'Venta',89),(34,'4902505089176','2019-03-07',0,49,'Venta',40),(35,'4902505089176','2019-03-07',0,1,'Venta',39),(36,'4902505089176','2019-03-07',0,1,'Venta',38),(37,'4902505089176','2019-03-07',0,1,'Venta',37),(38,'4902505089176','2019-03-07',0,1,'Venta',36),(39,'4902505089176','2019-03-07',0,3,'Venta',33);
...
INSERT INTO `marca` VALUES (1,'Pilot'),(2,'Bic');
...
INSERT INTO `pago_cliente` VALUES (1,'2019-02-19',1,1,0,'',100.00),(2,'2019-03-07',2,1,0,'',10.00);
...
CREATE TABLE `producto` (
  ...
  KEY `02_fk_marca_id` (`marca`),
  CONSTRAINT `01_fk_categoria_idcate` FOREIGN KEY (`idCategoria`) REFERENCES `categoria` (`idCategoria`),
  CONSTRAINT `02_fk_marca_id` FOREIGN KEY (`marca`) REFERENCES `marca` (`IDMARCA`)
) ENGINE=InnoDB DEFAULT CHARSET=ucs2 COLLATE=ucs2_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `producto` VALUES ('4902505089176',3,'Tinta de marcador color negra',20.00,30.00,28.00,1,'','');
...
INSERT INTO `proveedor` VALUES (1,'Vida en Linea','Vid@Online','Barrio el Porvenir','El Progreso','Guastatoya',79456321,'www.vidaenlinea.com','vidalinea@gmail.com','Oscar Antonio Valiente Arreaga',5960,6020);
...
CREATE TABLE `venta` (
  ...
  `total` decimal(8,2) DEFAULT NULL,
  PRIMARY KEY (`idventa`),
  KEY `01_fk_cliente` (`idcliente`) USING BTREE,
  KEY `02_fk_venta` (`idtipo_venta`) USING BTREE,
  KEY `03_fk_formapago` (`idFormapago`),
  CONSTRAINT `fk_03` FOREIGN KEY (`idFormapago`) REFERENCES `formapago` (`idFormapago`),
  CONSTRAINT `fk_01` FOREIGN KEY (`idcliente`) REFERENCES `cliente` (`idcliente`),
  CONSTRAINT `fk_02` FOREIGN KEY (`idtipo_venta`) REFERENCES `tipo_venta` (`idtipo_venta`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=ucs2 COLLATE=ucs2_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `venta` VALUES (13,'2019-03-07',2,1,1,0,'',30.00),(14,'2019-03-08',2,1,1,0,'',60.00),(15,'2019-03-06',2,1,1,0,'',150.00),(16,'2019-02-15',2,1,1,0,'',90.00),(17,'2018-12-13',2,1,1,0,'',30.00),(18,'2019-03-07',1,1,1,0,'',1470.00),(19,'2019-03-07',2,1,1,0,'',30.00),(20,'2019-03-07',2,1,1,0,'',30.00),(21,'2019-03-07',2,1,1,0,'',30.00),(22,'2019-03-07',2,1,1,0,'',30.00),(23,'2019-03-07',2,2,1,0,'',90.00);
...
-- Dump completed on 2019-03-07 15:27:37
