...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-03-2019 a las 03:18:37
...
(3391000207, 'prueba detipo de cuenta', 1, 1, '5000.00');
...
--
ALTER TABLE `inventario`
  MODIFY `idInventario` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
